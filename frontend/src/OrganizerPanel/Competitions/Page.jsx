    ...
    return (
        <div className="page">
            ...
            <div className="table-table">
                <div className="f-cl">
                    <div className="org-com-top f-b-c">
                        <div className="competitions-status f">
                            <div className="section f pending">
                                <p>Pending</p>
                                <span>12</span>
                            </div>
                            <div className="section f rejected">
                                <p>Rejected</p>
                                <span>1</span>
                            </div>
                            <div className="section f accepted">
                                <p>Accepted</p>
                                <span>54</span>
                            </div>
                        </div>
